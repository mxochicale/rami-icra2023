...
J.-F. Chen et al., 1997 in International Journal of Imaging Systems and Technology;
F. F. Dressler et al., 2021 in Urologia Internationalis;
}

\begin{frame}{Optimal scanning plan for fetal US biometry}
      \begin{figure}
        \centering
        \includegraphics[width=1.0\textwidth]{optimal-scanning-plane/outputs/drawing-v01}
