...
Fig~\ref{fig:results} shows the time series from one experienced clinician and one non-clinicians while looking for an optimal scanning plane of the four-chamber view.
